...
export class InstrAccountHeaderModel {
  static readonly LENGTH = 64 * 4 + 77 * 8 + 4 * 32; // 1000 bytes
  ...
  static readonly OFFSET_LUT_ADDRESS = 416;
  static readonly OFFSET_DRV_COUNT = 448;
  static readonly OFFSET_SLOT = 452;
  static readonly OFFSET_CREATOR = 456;
  static readonly OFFSET_LAST_TIME = 488;
  static readonly OFFSET_DISTRIB_TIME = 492;
  static readonly OFFSET_BASE_CRNCY_INDEX = 496;
  static readonly OFFSET_INSTANCE_COUNTER = 500;
  static readonly OFFSET_VARIANCE_COUNTER = 504;
  static readonly OFFSET_BIDS_TREE_NODES_COUNT = 508;
  static readonly OFFSET_BIDS_TREE_LINES_ENTRY = 512;
  static readonly OFFSET_BIDS_TREE_ORDERS_ENTRY = 516;
  static readonly OFFSET_ASKS_TREE_NODES_COUNT = 520;
  static readonly OFFSET_ASKS_TREE_LINES_ENTRY = 524;
  static readonly OFFSET_ASKS_TREE_ORDERS_ENTRY = 528;
  static readonly OFFSET_BID_LINES_BEGIN = 532;
  static readonly OFFSET_BID_LINES_END = 536;
  static readonly OFFSET_BID_LINES_COUNT = 540;
  static readonly OFFSET_ASK_LINES_BEGIN = 544;
  static readonly OFFSET_ASK_LINES_END = 548;
  static readonly OFFSET_ASK_LINES_COUNT = 552;
  static readonly OFFSET_BID_ORDERS_COUNT = 556;
  static readonly OFFSET_ASK_ORDERS_COUNT = 560;
  static readonly OFFSET_FIXING_TIME = 564;
  static readonly OFFSET_FIXING_CRNCY_TOKENS = 568;
  static readonly OFFSET_FIXING_ASSET_TOKENS = 576;
  static readonly OFFSET_COUNTER = 584;
  static readonly OFFSET_PROTOCOL_FEES = 592;
  static readonly OFFSET_HITS_COUNTER = 600;
  static readonly OFFSET_LAST_ASSET_TOKENS = 608;
  static readonly OFFSET_LAST_CRNCY_TOKENS = 616;
  static readonly OFFSET_PERP_UNDERLYING_PX = 624;
  static readonly OFFSET_FIXING_PX = 632;
  static readonly OFFSET_AVG_SPREAD = 640;
  static readonly OFFSET_LAST_SPREAD = 648;
  static readonly OFFSET_LAST_SPREAD_TIME = 656;
  static readonly OFFSET_TOTAL_SPREAD_PERIOD = 660;
  static readonly OFFSET_PREV_DAY_ASSET_TOKENS = 664;
  static readonly OFFSET_PREV_DAY_CRNCY_TOKENS = 672;
  static readonly OFFSET_ALLTIME_ASSET_TOKENS = 680;
  static readonly OFFSET_ALLTIME_CRNCY_TOKENS = 688;
  static readonly OFFSET_DAY_TRADES = 696;
  static readonly OFFSET_LP_DAY_TRADES = 700;
  static readonly OFFSET_LP_ALLTIME_FEES = 704;
  static readonly OFFSET_LP_DAY_FEES = 712;
  static readonly OFFSET_LP_PREV_DAY_TRADES = 720;
  static readonly OFFSET_LP_TIME = 724;
  static readonly OFFSET_FEES_TIME = 728;
  static readonly OFFSET_CREATION_TIME = 732;
  static readonly OFFSET_DEC_FACTOR = 736;
  static readonly OFFSET_PERP_SLOT = 744;
  static readonly OFFSET_PERP_TIME = 748;
  static readonly OFFSET_PERP_FUNDING_RATE_SLOT = 752;
  static readonly OFFSET_PERP_FUNDING_RATE_TIME = 756;
  static readonly OFFSET_PERP_LONG_PX_TREE_NODES_COUNT = 760;
  static readonly OFFSET_PERP_LONG_PX_TREE_ENTRY = 764;
  static readonly OFFSET_PERP_SHORT_PX_TREE_NODES_COUNT = 768;
  static readonly OFFSET_PERP_SHORT_PX_TREE_ENTRY = 772;
  static readonly OFFSET_PERP_REBALANCE_TIME_TREE_NODES_COUNT = 776;
  static readonly OFFSET_PERP_REBALANCE_TIME_TREE_ENTRY = 780;
  static readonly OFFSET_PERP_BIDS_TREE_NODES_COUNT = 784;
  static readonly OFFSET_PERP_BIDS_TREE_LINES_ENTRY = 788;
  static readonly OFFSET_PERP_BIDS_TREE_ORDERS_ENTRY = 792;
  static readonly OFFSET_PERP_ASKS_TREE_NODES_COUNT = 796;
  static readonly OFFSET_PERP_ASKS_TREE_LINES_ENTRY = 800;
  static readonly OFFSET_PERP_ASKS_TREE_ORDERS_ENTRY = 804;
  static readonly OFFSET_PERP_BID_LINES_BEGIN = 808;
  static readonly OFFSET_PERP_BID_LINES_END = 812;
  static readonly OFFSET_PERP_BID_LINES_COUNT = 816;
  static readonly OFFSET_PERP_ASK_LINES_BEGIN = 820;
  static readonly OFFSET_PERP_ASK_LINES_END = 824;
  static readonly OFFSET_PERP_ASK_LINES_COUNT = 828;
  static readonly OFFSET_PERP_BID_ORDERS_COUNT = 832;
  static readonly OFFSET_PERP_ASK_ORDERS_COUNT = 836;
  static readonly OFFSET_PERP_LONG_SPOT_PRICE_FOR_WITHDROWAL = 840;
  static readonly OFFSET_PERP_SHORT_SPOT_PRICE_FOR_WITHDROWAL = 848;
  static readonly OFFSET_PERP_SOC_LOSS_LONG_RATE = 856;
  static readonly OFFSET_PERP_SOC_LOSS_SHORT_RATE = 864;
  static readonly OFFSET_PERP_FUNDING_RATE = 872;
  static readonly OFFSET_PERP_FUNDING_FUNDS = 880;
  static readonly OFFSET_PERP_SOC_LOSS_FUNDS = 888;
  static readonly OFFSET_PERP_PREV_DAY_ASSET_TOKENS = 896;
  static readonly OFFSET_PERP_PREV_DAY_CRNCY_TOKENS = 904;
  static readonly OFFSET_PERP_ALLTIME_ASSET_TOKENS = 912;
  static readonly OFFSET_PERP_ALLTIME_CRNCY_TOKENS = 920;
  static readonly OFFSET_LIQUIDATION_THRESHOLD = 928;
  static readonly OFFSET_SEATS_RESERVE = 936;
  static readonly OFFSET_RESERVED_VALUE4 = 944;
  static readonly OFFSET_RESERVED_VALUE5 = 952;
  static readonly OFFSET_RESERVED_VALUE6 = 960;
  static readonly OFFSET_RESERVED_VALUE7 = 968;
  static readonly OFFSET_RESERVED_VALUE8 = 976;
  static readonly OFFSET_RESERVED_VALUE9 = 984;
  static readonly OFFSET_RESERVED_VALUE10 = 992;
